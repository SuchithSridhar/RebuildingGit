 ...
 *      java git.DumpObj FILE...
 *  where each FILE is a file produced by GitUtils.writeObject (or any file
 *  containing a serialized object).  This will simply read FILE,
 *  deserialize it, and call the dump method on the resulting Object.
 *  The object must implement the git.Dumpable interface for this
...
public class DumpObj {
    ...
    public static void main(String... files) {
        for (String fileName : files) {
            Dumpable obj = GitUtils.readObject(new File(fileName),
                                                  Dumpable.class);
            obj.dump();
            System.out.println("---");
        }
